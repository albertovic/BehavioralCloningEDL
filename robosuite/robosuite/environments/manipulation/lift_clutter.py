...
class LiftClutter(ManipulationEnv):
    """
    ...
    def _load_model(self):
        ...
        self.blue_cylinder = CylinderObject(name="blue_cylinder", size=[0.02, 0.04], rgba=[0, 0, 1, 1])
        self.blue_cube = BoxObject(name="blue_cube", size_min=[0.020, 0.020, 0.020], size_max=[0.022, 0.022, 0.022], rgba=[0, 0, 1, 1])
        self.red_cylinder = CylinderObject(name="red_cylinder", size=[0.03, 0.04], rgba=[1, 0, 0, 1])
        ...
        if self.placement_initializer is not None:
            ...
            self.placement_initializer.add_objects(self.blue_cylinder)
            self.placement_initializer.add_objects(self.blue_cube)
            self.placement_initializer.add_objects(self.red_cylinder)
        else:
        ...
        self.model = ManipulationTask(
            ...
            mujoco_objects=[self.cube, self.blue_cylinder, self.blue_cube, self.red_cylinder]
        )
