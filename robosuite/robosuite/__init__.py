...
from robosuite.environments.manipulation.lift_giraffe import LiftGiraffe
from robosuite.environments.manipulation.lift_clutter import LiftClutter
from robosuite.environments.manipulation.lift_improved import LiftImproved
