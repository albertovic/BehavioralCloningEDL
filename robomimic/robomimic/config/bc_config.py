...
class BCConfig(BaseConfig):
    ...
    def algo_config(self):
        ...
        # stochastic EDL policy settings
        self.algo.edl.enabled = False                    # whether to train an EDL policy
        self.algo.edl.regularizer_coeff = 0.2           # weight of the evidence regularizer
        self.algo.edl.warmup_percentage = 0.25          # percentage of epochs to anneal the regularizer

        # stochastic EDL policy settings
        self.algo.edl_frame_stacking.enabled = False                    # whether to train an EDL policy
        self.algo.edl_frame_stacking.regularizer_coeff = 0.2           # weight of the evidence regularizer
        self.algo.edl_frame_stacking.warmup_percentage = 0.25          # percentage of epochs to anneal the regularizer
        self.algo.edl_frame_stacking.frame_stacking = 3                 # number of frames to stack for temporal memory in EDL policy

        # stochastic EDL policy settings
        self.algo.edl_hybrid_frame_stacking.enabled = False                    # whether to train an EDL policy
        self.algo.edl_hybrid_frame_stacking.nsur_regularizer_coeff = 0.2           # weight of the evidence regularizer
        self.algo.edl_hybrid_frame_stacking.ur_regularizer_coeff = 0.2
        self.algo.edl_hybrid_frame_stacking.warmup_percentage = 0.25          # percentage of epochs to anneal the regularizer
        self.algo.edl_hybrid_frame_stacking.frame_stacking = 3                 # number of frames to stack for temporal memory in EDL policy


        # stochastic EDL policy settings
        self.algo.edl_frame_stacking_multihead.enabled = False                    # whether to train an EDL policy
        self.algo.edl_frame_stacking_multihead.regularizer_coeff = 0.2           # weight of the evidence regularizer
        self.algo.edl_frame_stacking_multihead.warmup_percentage = 0.25          # percentage of epochs to anneal the regularizer
        self.algo.edl_frame_stacking_multihead.frame_stacking = 3                 # number of frames to stack for temporal memory in EDL policy
        self.algo.edl_frame_stacking_multihead.gripper_coefficient = 50.0
